                ...
                <div class="px-4 py-5 space-y-6 bg-white sm:p-6">
                    <div class="grid grid-flow-col grid-rows-1 gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-2">
                                <img
                                    ...
                                    :alt="model.name"
                                    class="object-cover w-64 h-48 max-w-sm p-1 bg-gray-300 border rounded"
                                />
                                <span
                                    v-else
                        ...
                        <div>
                            ...
                            <div class="flex items-center mt-2">
                                <img
                                    v-if="model.bg_image_url"
                                    :src="model.bg_image_url"
                                    :alt="model.name"
                                    class="object-cover w-64 h-48 bg-gray-300 border rounded"
                                />
                                <span
                                    v-else
                                    class="flex items-center justify-center w-12 h-12 overflow-hidden bg-gray-100 rounded-full"
...
function onBgImageChoose(ev) {
    const file = ev.target.files[0];

    const reader = new FileReader();
    reader.onload = () => {
        model.value.bg_image = reader.result;

        model.value.bg_image_url = reader.result;
        ev.target.value = "";
    };
    reader.readAsDataURL(file);
}
